...
public class ContactView extends LinearLayout {
    ...
    private void handleClickEdit(){
        ...
        btnUpdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateContactList();
                Toast.makeText(getContext(), "Update reussie", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        });
    }
    ...
    private void handleClickDeleteContact(){
        ...
        builder.setMessage("Vous voulez supprimer ?");

        builder.setPositiveButton("OUI", (DialogInterface dialog, int which) ->{
            ContactManager.delete(getContext(), contact.getId());
            LinearLayout ll = (LinearLayout) getParent();
            ll.removeView(this);
            Toast.makeText(getContext(), "Supprimer contact", Toast.LENGTH_LONG).show();
        });

        builder.setNegativeButton("NON", (DialogInterface dialog, int which) ->{
    ...
    private void handleChangeImage(){
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
        builder.setTitle("Changer l'image");
        builder.setItems(new CharSequence[]{"prendre des photos", "Choisir l'image"}, new DialogInterface.OnClickListener() {
            @Override
    ...
    private void handleChooseFromGallery(){
        Toast.makeText(getContext(), "choisir photo", Toast.LENGTH_LONG).show();
